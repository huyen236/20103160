...
import { IApplyJobByTimeStatistic, ICareerDocument, IJobApprovalStatistic, IJobMappingDocument, IUserDocument } from 'src/interfaces';
...
export class StatisticService {
    constructor(
        @InjectModel('job-mapping') private readonly jobMappingModel: Model<IJobMappingDocument>,
